...
<head>
    ...
    <style>
        ...
        .main-registry-container { max-width: 1300px; margin: 0 auto; }
        ...
        .log-row { border-bottom: 1px solid #f8f9fa; }
        ...
        /* Ensure remarks don't break layout */
        .remarks-text {
            max-width: 250px;
            white-space: nowrap;
            overflow: hidden;
            ...
            <div class="modal-content border-0 shadow">
                <form method="POST">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <label class="fw-bold small mb-1">Update Condition To:</label>
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0 align-middle">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="log-row">
                                            <td class="fw-bold">#<?= htmlspecialchars($row['asset_id']) ?></td>
                                            <td>
                                            ...
                                            <td class="text-muted small"><?= htmlspecialchars($row['serial_number'] ?? 'N/A') ?></td>
                                            <td>
                                                <span class="badge-status bg-danger-subtle text-danger border border-danger-subtle">
                                                    <?= strtoupper($row['condition_status']) ?>
                                                </span>
                                            </td>
                                            <td class="fw-bold text-uppercase" style="font-size: 0.7rem;">
                                                <?= htmlspecialchars($row['assigned_to'] ?? 'NOT ASSIGNED') ?>
                                            </td>
                                            <td>
                                                <div class="remarks-text" title="<?= htmlspecialchars($row['remarks']) ?>">
                                    ...
                                    <?php endwhile; else: ?>
                                        <tr><td colspan="7" class="text-center py-5 text-muted fw-bold">NO DAMAGED ASSETS FOUND</td></tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
                        </div>
